...
width = int(cap.get(cv2.CAP_PRP_FRAME_WIDTH))
height = int(cap.get(cv2.CAP_PRP_FRAME_HEIGHT))
...
def drawHandLandmarks(image, hand_landmarks):
    ...
    if hand_landmarks:
        for landmarks in hand_landmarks:
            mp_drawing.dra_landmarks(image, landmarks, mp_hands.HAND_CONNECTIONS)
